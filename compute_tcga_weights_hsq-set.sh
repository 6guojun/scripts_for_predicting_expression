...
PRE_GEXP="TCGA-BRCA_train.log2.txt"
...
Rscript FUSION.compute_weights.R --bfile $OUT --tmp $OUT.ALL.tmp --out $FINAL_OUT --verbose 0 --hsq_set 0.098 --PATH_gcta $GCTA --PATH_gemma $GEMMA --models blup,top1,enet
